...
<div class="sl-mainpanel">
	...
	<div class="sl-pagebody">
		...
		<div class="card pd-20 pd-sm-40">
					...
					<div class="row mg-b-25">
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" value="{{$product->product_name_en}}" name="product_name_en" id="exampleInputEmail1" aria-describedby="emailHelp" >
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" value="{{$product->product_name_bn}}" name="product_name_bn" id="exampleInputEmail1" aria-describedby="emailHelp" >
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" value="{{$product->product_code}}" name="product_code" id="exampleInputEmail1" aria-describedby="emailHelp" >
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" value="{{$product->product_qty}}"  name="product_qty" id="exampleInputEmail1" aria-describedby="emailHelp" >
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" value="{{$product->product_tags_en}}" name="product_tags_en" id="exampleInputEmail1" aria-describedby="emailHelp" data-role="tagsinput" >
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" value="{{$product->product_tags_bn}}" name="product_tags_bn" id="exampleInputEmail1" aria-describedby="emailHelp" data-role="tagsinput">
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" value="{{$product->product_size_en}}" name="product_size_en" id="exampleInputEmail1" aria-describedby="emailHelp" data-role="tagsinput">
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" value="{{$product->product_size_bn}}" name="product_size_bn" id="exampleInputEmail1" aria-describedby="emailHelp" data-role="tagsinput">
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" value="{{$product->product_color_en}}" name="product_color_en" id="exampleInputEmail1" aria-describedby="emailHelp" data-role="tagsinput">
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" value="{{$product->product_color_bn}}" name="product_color_bn" id="exampleInputEmail1" aria-describedby="emailHelp" data-role="tagsinput">
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" value="{{$product->selling_price}}" name="selling_price" id="exampleInputEmail1" aria-describedby="emailHelp" >
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" value="{{$product->discount_price}}" name="discount_price" id="exampleInputEmail1" aria-describedby="emailHelp" >
						...
						<div class="col-lg-4">
							...
							<label class="ckbox">
								<input type="checkbox" name="hot_deals" {{$product->hot_deals==1? 'checked':''}}  id="hot_deals">
						...
						<div class="col-lg-4">
							...
							<label class="ckbox">
								<input type="checkbox" name="featured" {{$product->featured==1? 'checked':''}}  id="featured">
						...
						<div class="col-lg-4">
							...
							<label class="ckbox">
								<input type="checkbox" name="special_offer" {{$product->special_offer==1? 'checked':''}}  id="special_offer">
						...
						<div class="col-lg-4">
							...
							<label class="ckbox">
								<input type="checkbox" name="special_deals" {{$product->special_deals==1? 'checked':''}}  id="special_deals">
            ...
            <h4 class="mt-4">Update Multiple Image</h4>
			<form method="POST" action="{{route('change.multi.img')}}" enctype="multipart/form-data">
				@csrf
				
			
			<div class="row row-sm mt-4" >
				
				@foreach($product->multi_img as $m_i)
				<div class="col-md-3">
					<div class="card align-items-center justify-content-center" >
						<img src="{{asset($m_i->photo_name)}}"  class="card-img-top" alt="..." height="100px" width="100px">
						<a href="{{route('multi.img.delete',$m_i->id)}}" onclick="return confirm('Are you sure to delete it?')" class="text-center mt-2" ><i class="far fa-trash-alt fa-2x text-danger"></i></a>
						<div class="card-body">
							<label >Change Image</label>
							<input type="file" class="form-control" name="photo_name[{{$m_i->id}}]">
						</div>
					</div>
				</div>
				@endforeach
			...
			<div class="row">
						<div class="col-md-4 ">
							<button class="btn btn-success ">Change Multiple Image</button>
						</div>
					</div>
			</form>

			<h4 class="mt-4">Update Main Thumbnail Image</h4>
			<form method="POST" action="{{route('change.main.img')}}" enctype="multipart/form-data">
				@csrf
			...
			<div class="row row-sm mt-4" >
				...
				<div class="col-md-3">
					<div class="card align-items-center justify-content-center" >
						<img src="{{asset($product->product_thumbnail)}}" class="card-img-top" alt="..." height="100px" width="100px">
						{{-- <a href="#" class="text-center mt-2" ><i class="far fa-trash-alt fa-2x text-danger"></i></a> --}}
						<div class="card-body">
							<label >Change Image</label>
			...
			<div class="row">
						<div class="col-md-4 ">
							<button class="btn btn-success ">Change Thumbnail</button>
						</div>
					</div>
			</form>
		</div>
