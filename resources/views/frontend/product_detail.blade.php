		...
		<div class="row  wow fadeInUp">
				...
				<div class="product-item-holder size-big single-product-gallery small-gallery">
					...
					<div id="owl-single-product">
						...
						<div class="single-product-gallery-item" id="slide{{$img->id}}">
							<a data-lightbox="image-{{$img->id}}" data-title="Gallery" href="{{asset($img->photo_name)}}">
			...
			<div class='col-sm-6 col-md-7 product-info-block'>
				<div class="product-info">
					<h1 class="name">@if(session()->get('language')=='english'){{$product->product_name_en}}@else {{$product->product_name_bn}} @endif</h1>
					...
					<div class="stock-container info-container m-t-10">
						<div class="row">
							<div class="col-sm-2">
								<div class="stock-box">
									<span class="label"> @if(session()->get('language')=='english')
										Availability :
										@else
										মজুদ আছে :
									@endif</span>
							...
							<div class="col-sm-9">
								<div class="stock-box">
									<span class="value">@if($product->product_qty < 1) 
										@if(session()->get('language')=='english')
										Out Of Stock
										@else
										পণ্য নেই
										...
										{{$product->product_qty}}
										@else
										{{bn_price($product->product_qty)}} টি
										@endif
										@endif 
									</span>
								</div>	
					...
					<div class="price-container info-container m-t-20">
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="price-box">
									@if($product->discount_price == NULL)
									<span class="price">@if(session()->get('language')=='english')
									...
									<span class="price">@if(session()->get('language')=='english')
										...
										{{bn_price($product->discount_price)}} 
									@endif</span>
									<span class="price-strike">@if(session()->get('language')=='english')
										{{$product->selling_price}}
										@else
										{{bn_price($product->selling_price)}} 
									@endif</span>
