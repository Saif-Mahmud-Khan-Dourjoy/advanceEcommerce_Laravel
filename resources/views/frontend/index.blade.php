	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-3 sidebar">
				...
				<!-- ================================== TOP NAVIGATION ================================== -->
	         @include('frontend.inc.sidenav')<!-- /.side-menu -->
					<!-- ================================== TOP NAVIGATION : END ================================== -->
								...
								<div class="products">
									<div class="hot-deal-wrapper">
										...
										@if($product->discount_price == NULL)
														<div class="tag new"><span>@if(session()->get('language')=='english') New
															@else
															নতুন
														@endif</span></div>
														@else
														...
														@endphp
														<div class="sale-offer-tag"><span>@if(session()->get('language')=='english') 
															{{round($discount)}}%
															@else
					...
					<div class="sidebar-widget outer-bottom-small wow fadeInUp">
						<h3 class="section-title">@if(session()->get('language')=='english')
                                Special Offer
							@else
                                বিশেষ অফার
				...
				<div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
					...
					<div id="hero">
						<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
							@php
							$slider=App\Models\Slider::where('status',1)->limit(5)->get();
							@endphp	
							...
							<div class="item" style="background-image: url({{asset($slider->slider_image)}});">
								<div class="container-fluid">
									<div class="caption bg-color vertical-center text-left">
										...
										@else
										<div class="slider-header fadeInDown-1">EShop</div>

										<div class="big-text fadeInDown-1">
											@if(session()->get('language')=='english'){{$slider->slider_title_en}}
											@else
										...
										<div class="excerpt fadeInDown-2 hidden-xs">
											...
											<span>@if(session()->get('language')=='english'){{$slider->slider_desc_en}}
												@else
												{{$slider->slider_desc_bn}}
											@endif</span>
										...
										<div class="button-holder fadeInDown-3">
											<a href="index6c11.html?page=single-product" class="btn-lg btn btn-uppercase btn-primary shop-now-button">@if(session()->get('language')=='english')Shop Now
												@else
												শপ নাউ
											@endif</a>
										</div>
					...
					<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
						<div class="more-info-tab clearfix ">
							<h3 class="new-product-title pull-left">@if(session()->get('language')=='english') New Products
								@else
								নতুন প্রোডাক্ট

							@endif</h3>
							<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
								<li class="active"><a data-transition-type="backSlide" href="#all" data-toggle="tab">@if(session()->get('language')=='english') All
									@else
									সব
								@endif</a></li>
								@php                                        
								...
								<li><a data-transition-type="backSlide" href="#category{{$cat->id}}" data-toggle="tab">@if(session()->get('language')=='english'){{$cat->category_name_en}}
									@else
							...
							<div class="tab-pane in active" id="all">			
								<div class="product-slider">
									<div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
										...
										$product=App\Models\Product::where('status',1)->get();
											...
											<div class="products">
												...
												<div class="product">		
													<div class="product-image">
														...
														@endphp
														<div class="tag sale"><span>@if(session()->get('language')=='english') 
															{{round($discount)}}%
															@else
															{{bn_price(round($discount))}}%
														@endif</span></div>
													...
													<div class="product-info text-left">
														<h3 class="name"><a href="detail.html">@if(session()->get('language')=='english') {{$product->product_name_en}}
															@else
							...
							<div class="tab-pane" id="category{{$cat->id}}">
								<div class="product-slider">
									<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
										@php
										$cat_product=App\Models\Product::where('category_id',$cat->id)->get()

										@endphp
										@forelse($cat_product as $cat_product)
										<div class="item item-carousel">
											<div class="products">
												...
												<div class="product">		
													<div class="product-image">
														<div class="image">
															@if(session()->get('language')== 'english')
															<a href="{{url('single_product/'.$cat_product->id.'/'.$cat_product->product_slug_en)}}">

															@else
															<a href="{{url('single_product/'.$cat_product->id.'/'.$cat_product->product_slug_bn)}}">
															@endif	<img  src="{{asset($cat_product->product_thumbnail)}}" alt=""></a>
														</div><!-- /.image -->			

															@if($cat_product->discount_price == NULL)
														<div class="tag new"><span>@if(session()->get('language')=='english') New
															@else
															নতুন
														@endif</span></div>
													...
													<div class="product-info text-left">
														<h3 class="name"><a href="detail.html">@if(session()->get('language')=='english') {{$cat_product->product_name_en}}
															@else
															{{$cat_product->product_name_bn}}
														@endif</a></h3>
														<div class="rating rateit-small"></div>
														<div class="description"></div>
														...
														<div class="product-price">	
															@if($cat_product->discount_price == NULL)
															@if(session()->get('language')=='english') {{$cat_product->selling_price}}
															@else
															{{bn_price($cat_product->selling_price)}}
														@endif
                                                             
															@else
															<span class="price">
																@if(session()->get('language')=='english') {{$cat_product->discount_price}}
															@else
															{{bn_price($cat_product->discount_price)}}
														@endif
																		</span>
															<span class="price-before-discount">
																@if(session()->get('language')=='english') {{$cat_product->selling_price}}
										...
										@empty
										<span class="btn btn-danger mb-5"> @if(session()->get('language')=='english') No Product Available @else কোন পণ্য নেই  @endif </span>
										@endforelse
										<!-- /.item -->
									</div><!-- /.home-owl-carousel -->
								</div><!-- /.product-slider -->
					...
					<section class="section featured-product wow fadeInUp">
						<h3 class="section-title">@if(session()->get('language')=='english')Featured products
						@else
                       ফিচারড পণ্য
										...
										<div class="product-image">
											<div class="image">
												@if(session()->get('language')== 'english')
															...
															@else
															<a href="{{url('single_product/'.$product->id.'/'.$product->product_slug_bn)}}">
															@endif <img  src="{{asset($product->product_thumbnail)}}" alt=""></a>
											</div><!-- /.image -->			
                                            @if($product->discount_price == NULL)
											<div class="tag hot"><span>@if(session()->get('language')=='english') Hot
															@else
															হট
														@endif</span></div>
														@else
														...
														@endphp
										   <div class="tag hot"><span>@if(session()->get('language')=='english') 
															{{round($discount)}}%
															@else
															{{bn_price(round($discount))}}%
														@endif</span></div>
