										...
										<div class="item item-carousel">
											<div class="products">
												...
												<div class="product">		
													<div class="product-image">
														<div class="image">
															<a href="{{route('single_product',$product->id)}}"><img  src="{{asset($product->product_thumbnail)}}" alt=""></a>
														</div><!-- /.image -->			
										...
										<div class="item item-carousel">
											<div class="products">
												...
												<div class="product">		
													<div class="product-image">
														<div class="image">
															<a href=""><img  src="{{asset($cat_product->product_thumbnail)}}" alt=""></a>
														</div><!-- /.image -->			
							...
							<div class="item item-carousel">
								<div class="products">
									...
									<div class="product">		
										<div class="product-image">
											<div class="image">
												<a href="detail.html"><img  src="{{asset('frontend')}}/assets/images/blank.gif" data-echo="{{asset('frontend')}}/assets/images/products/p7.jpg" alt=""></a>
											</div><!-- /.image -->			
